...
struct Config {
    ...
    static constexpr bool phase_correct_pwm = false;
...
PID controllers[] {
    ...
    {
        5.6,  // Kp: proportional gain
        300,   // Ki: integral gain
        0.037, // Kd: derivative gain
        Ts,    // Ts: sampling time
...
void onReceive(int count) {
    ...
    Serial.print(data);
    Serial.print('\t');
    Serial.print(touch.touched[idx]);
    Serial.print('\t');
    Serial.println(idx);
